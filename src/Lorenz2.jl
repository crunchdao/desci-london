#= 
Author(s): Mattia Petrini, Matteo Manzi
=#
...
n = 50
gif_range = range(0, stop = 20, length = n)
...
anim = @animate for l in gif_range
    ...
    Plots.heatmap(x0_list, y0_list, transpose(f), axes=false)
end 
``
gif(anim, "lorenz.gif", fps = n/5)
